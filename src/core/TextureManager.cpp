...
void TextureManager::Initialize() {
	...
	Device->CreateTexture(Width, Height, 1, D3DUSAGE_DEPTHSTENCIL, (D3DFORMAT)MAKEFOURCC('I', 'N', 'T', 'Z'), D3DPOOL_DEFAULT, &TheTextureManager->DepthTextureBeforeWater, NULL);
	TheTextureManager->RegisterTexture("TESR_DepthBufferBeforeWater",(IDirect3DBaseTexture9**)&TheTextureManager->DepthTextureBeforeWater);
	...
	NvAPI_D3D9_RegisterResource(TheTextureManager->DepthTextureBeforeWater);
